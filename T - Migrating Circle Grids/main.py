...
def draw(screen, etc) :
    ...
    x_speed = (60*etc.knob1)-30 #horizontal speed on knob1
    y_speed = (60*etc.knob2)-30 #vertical speed on knob2
    ...
    trigger = False
    if x1_nudge > 640 : x1_nudge = -640
    if x2_nudge > 640 : x2_nudge = -640
    if x3_nudge > 640 : x3_nudge = -640
    if x4_nudge > 640 : x4_nudge = -640
    ...
    if y1_nudge > 360 : y1_nudge = -360
    if y2_nudge > 360 : y2_nudge = -360
    if y3_nudge > 360 : y3_nudge = -360
    if y4_nudge > 360 : y4_nudge = -360
    ...
    for i in range(0, 3) :
        ...
        for j in range(0, 5) :
            x1 = (j*(1280/5))+(1280/10)+int(x1_nudge)
            y1 = (i*(720/3))+(720/6)+int(y1_nudge)
               
            restRad = int(50*etc.knob3)+2
    ...
    for i in range(0, 3) :
        ...
        for j in range(0, 5) :
            x2 = (j*(1280/5))+(1280/10)+int(x2_nudge)
            y2 = (i*(720/3))+(720/6)+int(y2_nudge)
    ...
    for i in range(0, 3) :
        ...
        for j in range(0, 5) :
            x3 = (j*(1280/5))+(1280/10)+int(x3_nudge)
            y3 = (i*(720/3))+(720/6)+int(y3_nudge)
    ...
    for i in range(0, 3) :
        ...
        for j in range(0, 5) :
            x4 = (j*(1280/5))+(1280/10)+int(x4_nudge)
            y4 = (i*(720/3))+(720/6)+int(y4_nudge)
